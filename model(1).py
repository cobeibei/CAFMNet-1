...
class embed_net(nn.Module):
    def __init__(self, class_num, dataset, arch='resnet50'):
        ...
        self.clfo = CLFO(in_channels=1024, out_channels=1024)  # 初始化 CLFO 模块
        self.clfr = CLFR(in_channels=1024)  # 初始化 CLFR 模块
    ...
    def forward(self, x1, x2, modal=0):
        ...
        if self.dataset == 'regdb':
            ...
            x_ = self.base_resnet.base.layer3(x_)
            x_ = self.clfo(x_)  # 应用 CLFO 模块
            x = self.clfr(x_)  # 应用 CLFR 模块
