...
if dataset == 'sysu':
    data_path = '/public/home/G19830015/VideoGroup/lpx/data/SYSU-MM01/'
    # data_path = 'E:/可见光红外行人重识别/data/SYSU-MM01/'

    log_path = args.log_path + 'sysu_log/'
    test_mode = [1, 2]  # thermal to visible
    pool_dim = 2048
elif dataset == 'regdb':
    data_path = '/public/home/G19830015/VideoGroup/lpx/data/RegDB/RegDB/'
    # data_path = 'E:/可见光红外行人重识别/data/RegDB/'
    log_path = args.log_path + 'regdb_log/'
    test_mode = [2, 1]  # visible to thermal
    pool_dim = 1024
elif dataset == 'llcm':
    data_path = '/public/home/G19830015/VideoGroup/lpx/data/LLCM/'
    # data_path = 'E:/可见光红外行人重识别/data/LLCM/'
...
transform_sysu = transforms.Compose([
    ...
    # RandomGrayscaleErasing(probability=args.erasing_p, sl=0.02, sh=0.4, r1=0.3),
])
...
def train(epoch):
    ...
    for batch_idx, (input1, input2, label1, label2) in enumerate(trainloader):
        # print("Batch size in trainloader:", input1.size(0))
        ...
        # print("out1 batch size before loss calculation:", out1.size(0))
        # print("labels batch size before loss calculation:", labels.size(0))
        if out1.size(0) != 144:
            num_to_add = 144 - out1.size(0)
            repeated_out1 = out1.repeat_interleave(2, dim=0)[:num_to_add]
            out1 = torch.cat([out1, repeated_out1], dim=0)
        
        labels = labels.long()
        loss_id = criterion_id(out1, labels)

        # print("out1 batch size after loss calculation:", out1.size(0))
        # print("labels batch size after loss calculation:", labels.size(0))
...
for epoch in range(start_epoch, 161 - start_epoch):
