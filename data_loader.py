...
class TestData(data.Dataset):
    def __init__(self, test_img_file, test_label, transform=None, img_size=(144, 384)):
        test_image = []
...
class TestDataOld(data.Dataset):
    def __init__(self, data_dir, test_img_file, test_label, transform=None, img_size=(144, 384)):
        test_image = []
        for i in range(len(test_img_file)):
